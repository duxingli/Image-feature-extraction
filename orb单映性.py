...
img0 = cv.imread('./images/7.jpg', cv.IMREAD_GRAYSCALE)
img1 = cv.imread('./images/5.jpg', cv.IMREAD_GRAYSCALE)

# sift = cv.SIFT_create()
# kp0, des0 = sift.detectAndCompute(img0, None)
# kp1, des1 = sift.detectAndCompute(img1, None)

# img0 = addGaussNoise(img0, mean=0.12, var=0.002)
# img1 = addGaussNoise(img0, mean=0.15, var=0.001)
# img0 = addSaltNoise(img0, amount=0.05)
# img1 = addSaltNoise(img1, amount=0.03)
